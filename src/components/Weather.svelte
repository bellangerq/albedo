...
<div class="Weather">
  <div transition:fade="{{ duration: 500 }}" class="Weather__Primary">
    ...
    {#if weather.feelsLike}
      <span class="Weather__FeelsLike">(feels like { weather.feelsLike }°C)</span>
    {/if}
  </div>

  <p transition:fade="{{ duration: 500 }}" class="Weather__Advice">Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
  ...
  {#if weather.minTemperature}
    <li class="Weather__SecondaryInfo" transition:fly="{{ x: -25, duration: 600, delay: 300 }}">
      <svg class="Weather__Icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
  ...
  {#if weather.wind}
    <li class="Weather__SecondaryInfo" transition:fly="{{ x: -25, duration: 600, delay: 600 }}">
      <svg class="Weather__Icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
  ...
  {#if weather.humidity}
    <li class="Weather__SecondaryInfo" transition:fly="{{ x: -25, duration: 600, delay: 900 }}">
      <svg class="Weather__Icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
